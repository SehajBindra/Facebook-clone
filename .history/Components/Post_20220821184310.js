...
function Post({ id, username, userImg, img, message, timestamp }) {
  ...
  return (
    <div className="flex flex-col">
      ...
      {session && (
        // {comments.length > 0 && (
        <div className="ml-5 rounded-2xl bg-white h-20 overflow-y-scroll scrollbar-thumb-black scrollbar-thin">
      ...
      {/* input box */}
      {session && (
        <form className="flex items-center p-4 bg-white rounded-2xl">
